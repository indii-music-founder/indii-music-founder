    ...
    for agent in agents:
        ...
        payload = {
            ...
            "supervisedTuningSpec": {
                "trainingDatasetUri": f"gs://indii-training-data/ft_export/r7/{agent}_train.jsonl",
                "validationDatasetUri": f"gs://indii-training-data/ft_export/r7/{agent}_eval.jsonl",
                "hyperParameters": {
                    "epochCount": "3"
                }
            },
