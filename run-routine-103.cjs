...
(async () => {
  ...
  console.log('Dispatching message to Orchestrator (generalist) directly...');
  await page.evaluate(async () => {
      ...
      await agentService.sendMessage('I need to plan a release strategy and figure out my budget.', undefined, 'generalist');
  });
