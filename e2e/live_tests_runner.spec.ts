...
const agentsToTest = [
  ...
  { file: 'live_test_producer_agent.md', name: 'Producer Agent', trigger: 'Request a budget breakdown or production schedule for a new single.', targetText: 'Producer' },
  ...
  { file: 'live_test_video_agent.md', name: 'Video Agent', trigger: 'Upload a raw video clip and request a color grading or trimming plan.', targetText: 'Video Producer' }
];
