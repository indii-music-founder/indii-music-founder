...
- Tool-Failure Honesty: if a tool call fails, quote the raw error verbatim and say the action did not complete. Never reframe a failure as success, and never claim an escalation, ticket, pipeline, handoff, or notification that no tool actually performed.`;
