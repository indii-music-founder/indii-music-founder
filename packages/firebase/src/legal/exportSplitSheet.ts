...
<div class="container">
  <div style="display:flex; justify-content:space-between; align-items:flex-start; border-bottom: 2px solid #111; padding-bottom:16px; margin-bottom:20px">
    ...
    <div style="text-align:right;font-size:12px;color:#666">
      <div style="font-size:18px;font-weight:bold;letter-spacing:2px;color:#111">indii</div>
  ...
  <div class="section">
    ...
    <div class="legal">
      ...
      <p><em>This document was generated by indii and is intended for reference purposes. Parties are advised to have this Agreement reviewed by qualified legal counsel before relying on it for legal purposes.</em></p>
    </div>
  </div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>${escapeHtml(c.name)}</td>
          <td>${escapeHtml(c.role)}</td>
          <td style="height:40px">${c.signed ? '(Digitally signed via indii)' : ''}</td>
  ...
  <div class="footer">
    Split Sheet generated by indii v0.1.0-beta.2 · ${escapeHtml(generatedAt)} · ID: ${escapeHtml(data.splitSheetId)}
  </div>
