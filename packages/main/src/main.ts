...
if (!gotTheLock) {
    ...
    app.on('ready', () => {
        ...
        const KNOWN_IPC_CHANNELS = new Set([
            ...
            'agent:get-history', 'agent:save-history', 'agent:delete-history', 'agent:extract-web-page',
            ...
            'video:render', 'video:open-folder', 'video:save-asset', 'video:get-default-path', 'video:compile-preview', 'video:read-artifact',
            'power:get-state',
