...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    computer: {
        ...
        click: (x: number, y: number, button?: 'left' | 'right' | 'double', sessionId?: string) => ipcRenderer.invoke('computer:click', { x, y, button, sessionId }),
        type: (text: string, sessionId?: string) => ipcRenderer.invoke('computer:type', { text, sessionId }),
        key: (combo: string, sessionId?: string) => ipcRenderer.invoke('computer:key', { combo, sessionId }),
        scroll: (dx: number, dy: number, sessionId?: string) => ipcRenderer.invoke('computer:scroll', { dx, dy, sessionId }),
