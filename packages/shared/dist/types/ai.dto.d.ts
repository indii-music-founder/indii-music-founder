...
export declare function isTextPart(part: ContentPart): part is TextPart;
export declare function isInlineDataPart(part: ContentPart): part is InlineDataPart;
export declare function isFunctionCallPart(part: ContentPart): part is FunctionCallPart;
export declare function isFunctionResponsePart(part: ContentPart): part is FunctionResponsePart;
