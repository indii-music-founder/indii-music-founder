...
import { ConversionEventSchema, OPTIMIZABLE_EVENT_TYPES, buildConversionEventId, } from './conversionEvent.js';
const VALID = {
...
describe('OPTIMIZABLE_EVENT_TYPES', () => {
    ...
    it('covers the outcomes we observe ourselves', () => {
        expect(OPTIMIZABLE_EVENT_TYPES).toEqual(expect.arrayContaining(['link_click', 'dsp_redirect', 'presave', 'sale']));
    });
});
describe('buildConversionEventId', () => {
    it('is deterministic for the same natural identity', () => {
        const parts = { platform: 'shopify', eventType: 'sale', sourceId: 'order-9' };
