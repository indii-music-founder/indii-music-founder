...
export function createHarnessRun<TOutput>(params: Omit<HarnessRun<TOutput>, 'runId' | 'createdAt' | 'schemaVersion'> & { runId?: string; createdAt?: string; schemaVersion?: number }): HarnessRun<TOutput> {
  return {
    ...params,
