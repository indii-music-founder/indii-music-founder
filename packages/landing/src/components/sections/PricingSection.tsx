...
const plans = [
  {
    ...
    monthlyPrice: 0,
    accentHex: '#00BCD4',
    audience: 'See how Connected Intelligence© coordinates your creative workflow in one bounded guided experience.',
  ...
  },
  {
    ...
    includes: ['Everything needed for active releases', 'Connected Intelligence© workflows', 'More working capacity'],
    cta: 'Choose Build',
    href: '#waitlist',
    featured: true,
  },
