 ...
 *
 * CRITICAL: This file defines the ONLY approved Autonomous models for this application.
...
const FORBIDDEN_PATTERNS: RegExp[] = [
    ...
    // NOTE: gemini-3-pro-image-preview and gemini-3.1-flash-image are ALLOWED
];
