                    ...
                    <div className="flex gap-1 mb-2">
                        {session.participants.slice(0, 3).map(agentId => {
                            ...
                            return (
                                ...
                                style={{
                                    backgroundColor: `color-mix(in srgb, ${identity.cssProperties['--agent-accent']} 10%, transparent)`,
                                    borderColor: `color-mix(in srgb, ${identity.cssProperties['--agent-border']} 30%, transparent)`,
                                    color: identity.cssProperties['--agent-accent']
                                }}>
                                    <AgentIcon iconKey={identity.iconKey} size={12} />
                                </div>
                            );
                        })}
