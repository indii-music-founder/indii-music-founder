        ...
        <>
            ...
            {currentModule !== 'road' && currentModule !== 'agent' && (
                <motion.button
                    ...
                    className="fixed z-[102] w-12 h-12 rounded-full bg-linear-to-br from-teal-400 to-cyan-500 shadow-lg shadow-teal-500/30 flex items-center justify-center active:shadow-teal-500/50 transition-shadow"
                    style={{
