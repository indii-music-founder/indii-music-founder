...
describe('AutonomousGenerationDialog', () => {
    const onClose = vi.fn();
    ...
    it('renders correctly when open', () => {
        ...
        expect(screen.getByText('Autonomous Image Generation')).toBeInTheDocument();
    ...
    it('handles successful generation', async () => {
        ...
        await waitFor(() => {
            ...
            expect(onImageGenerated).toHaveBeenCalledWith('http://example.com/image.png', expect.stringContaining('Gen: test prompt'));
