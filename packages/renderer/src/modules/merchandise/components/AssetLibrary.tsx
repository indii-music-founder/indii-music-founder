                    ...
                    <div className="grid grid-cols-3 gap-2 pb-2">
                        {filteredAssets.map((asset) => (
                            ...
                            >
                                ...
                                />
                                <div className="absolute inset-0 bg-linear-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
