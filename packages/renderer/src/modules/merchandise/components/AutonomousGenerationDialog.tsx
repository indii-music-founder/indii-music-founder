...
export const AutonomousGenerationDialog: React.FC<AutonomousGenerationDialogProps> = ({
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            logger.error('Autonomous generation error:', error);
            toast.dismiss(loadingId);
            ...
            <MerchCard className="w-full max-w-2xl mx-4 p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-white">Autonomous Image Generation</h3>
                            <p className="text-xs text-neutral-400">Create custom graphics autonomously</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
