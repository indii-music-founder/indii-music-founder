    ...
    <div className="p-6 bg-zinc-950 text-white min-h-screen space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          aria-label={isSwarmActive ? 'Halt All Agents' : 'Activate Swarm'}
          className={twMerge(
            "flex items-center gap-2 px-4 py-2 rounded-md font-semibold transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500",
            isSwarmActive ? "bg-red-500/10 text-red-500 hover:bg-red-500/20 border border-red-500/30" : "bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500/20 border border-emerald-500/30"
          )}
        >
          <Power size={18} />
