                ...
                {isProcessing && (
                    ...
                    >
                        <div className="relative mt-1 flex-shrink-0">
                            <div className="absolute -inset-1 bg-green-500/20 rounded-full blur-sm opacity-100 transition-opacity"></div>
                            <div className="w-9 h-9 rounded-full bg-linear-to-br from-green-600 to-green-800 flex items-center justify-center text-xs font-bold relative z-10 border border-green-500/30">
                        ...
                        <div className="bg-linear-to-br from-[rgba(16,16,22,0.6)] to-[rgba(10,10,14,0.9)] border border-white/5 rounded-[1.2rem] rounded-tl-sm px-5 py-4 flex items-center justify-center shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)] h-[48px]">
                            <div className="flex items-center gap-1.5" role="status" aria-label="AI is thinking">
                                ...
                                <motion.div animate={{ y: [0, -4, 0] }} transition={{ repeat: Infinity, duration: 0.6, ease: "easeInOut", delay: 0.3 }} className="w-1.5 h-1.5 bg-green-400/60 rounded-full" />
                            </div>
                        </div>
                    </motion.div>
                )}
