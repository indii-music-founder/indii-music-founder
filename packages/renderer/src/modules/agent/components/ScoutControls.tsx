            ...
            <div className="relative bg-slate-900/90 backdrop-blur-xl border border-slate-700/50 p-1.5 rounded-2xl shadow-2xl flex items-center gap-2">
                ...
                <div className="relative flex-1 min-w-[180px] group/input">
                    <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
                        <Search className="h-4 w-4 text-slate-500 group-focus-within/input:text-dept-creative transition-colors" />
                    </div>
                    <input
                        type="text"
                        value={city}
                ...
                <div className="relative flex-1 min-w-[180px] group/input">
                    <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
                        <Wand2 className="h-4 w-4 text-slate-500 group-focus-within/input:text-dept-creative transition-colors" />
                    </div>
                    <input
                        type="text"
                        value={genre}
                ...
                <button
                    ...
                    className={`
                        flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm tracking-wide shadow-lg transition-all outline-none focus-visible:ring-2 focus-visible:ring-dept-creative focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900
                        ${isScanning
                            ? 'bg-slate-800 text-slate-500 cursor-not-allowed shadow-none'
                            : 'bg-dept-creative text-black hover:brightness-110 active:scale-[0.98] shadow-dept-creative/20'}
                    `}
                >
                    {isScanning ? (
                        <>
