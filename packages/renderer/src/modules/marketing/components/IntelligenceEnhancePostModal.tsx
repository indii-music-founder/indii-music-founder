...
export default function IntelligenceEnhancePostModal({
  post,
  onClose,
  onApply,
  ...
  const handleEnhance = async () => {
    ...
    try {
      const result = await CampaignIntelligence.enhancePostCopy(post, enhancementType);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Use Intelligence to improve your post
              </p>
            </div>
          </div>
          <button
