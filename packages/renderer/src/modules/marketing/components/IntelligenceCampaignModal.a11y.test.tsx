...
// Mock CampaignIntelligenceService
...
describe('IntelligenceCampaignModal Accessibility', () => {
    ...
    it('should have no automatically detectable accessibility violations', async () => {
        const { container } = render(
            <IntelligenceCampaignModal onClose={mockOnClose} onSave={mockOnSave} />
        );
    ...
    it('should implement the dialog role correctly', () => {
        render(<IntelligenceCampaignModal onClose={mockOnClose} onSave={mockOnSave} />);
    ...
    it('Scenario 3: Loading state should be announced', async () => {
        ...
        (CampaignIntelligence.generateCampaign as import("vitest").Mock).mockImplementation(() => new Promise(resolve => setTimeout(resolve, 500)));
