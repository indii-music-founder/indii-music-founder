...
interface IntelligencePredictionPanelProps {
    campaign: CampaignAsset;
}

export default function IntelligencePredictionPanel({ campaign }: IntelligencePredictionPanelProps) {
            ...
            <div className="bg-black/20 backdrop-blur-xl border border-white/5 rounded-xl p-6 shadow-xl">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-sm font-semibold text-white">Intelligence Prediction</h3>
                ...
                <p className="text-sm text-gray-400 mb-6 leading-relaxed">
                    Get Intelligence-powered insights on how your campaign might perform.
                </p>
