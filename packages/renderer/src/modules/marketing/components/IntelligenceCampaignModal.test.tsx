...
describe('IntelligenceCampaignModal', () => {
    const defaultProps = {
        onClose: vi.fn(),
        onSave: vi.fn(),
    };
    ...
    it('renders the initial form state correctly', () => {
        ...
        expect(screen.getByText('Intelligence Campaign Generator')).toBeInTheDocument();
    ...
    it('shows loading state and handles successful generation', async () => {
        ...
        (CampaignIntelligence.generateCampaign as import("vitest").Mock).mockReturnValue(generatePromise);
    ...
    it('handles generation errors gracefully', async () => {
        const user = userEvent.setup();
        (CampaignIntelligence.generateCampaign as import("vitest").Mock).mockRejectedValue(new Error('Intelligence overloaded'));
    ...
    it('calls onSave when Create Campaign is clicked', async () => {
        ...
        expect(CampaignIntelligence.planToCampaignAsset).toHaveBeenCalledWith(mockGeneratedPlan, expect.any(String));
