        ...
        <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                ...
                <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                    <motion.div
                        className="h-full bg-linear-to-r from-indigo-500 to-green-500 rounded-full"
                        initial={{ width: 0 }}
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    {/* Avatar */}
                                    <div className="w-9 h-9 rounded-full bg-linear-to-br from-indigo-500/30 to-green-500/30 border border-white/10 flex items-center justify-center flex-shrink-0">
