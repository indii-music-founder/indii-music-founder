                ...
                {selectedClip ? (
                    ...
                    <div className="p-4 bg-linear-to-br from-gray-800/40 to-gray-900/40 m-2 rounded-lg border border-gray-800 shadow-xl space-y-4 md:col-span-2 xl:col-span-3">
                        ...
                        <ul className="text-[11px] font-medium text-gray-400 text-left space-y-2">
                            ...
                            <li className="flex items-start gap-2"><span className="text-blue-400 mt-0.5">&bull;</span> <span className="leading-snug"><strong>Create a video:</strong> Click <span className="font-bold text-white bg-white/5 px-1.5 py-0.5 rounded ring-1 ring-white/10 text-[9px]">&larr; Back to Director</span> to use the Autonomous generator.</span></li>
                        </ul>
                    </div>
                )}
            </div>
