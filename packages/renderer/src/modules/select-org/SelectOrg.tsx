...
export default function SelectOrg() {
    ...
    return (
        <div className="fixed inset-0 bg-background text-white flex flex-col md:flex-row overflow-hidden selection:bg-green-500/30">
            ...
            <div className="hidden md:flex w-1/3 max-w-md relative flex-col justify-between p-12 border-r border-white/5 bg-black/40 backdrop-blur-xl z-10">
                <div>
                    <div className="w-12 h-12 rounded-xl bg-linear-to-br from-green-600 to-blue-600 flex items-center justify-center mb-8 shadow-lg shadow-green-900/20">
                ...
                >
                    <AnimatePresence mode="wait">
                        {!showCreate && hasOrgs ? (
                            ...
                            >
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`group flex items-center justify-between p-4 rounded-2xl border transition-all duration-300 text-left overflow-hidden relative ${isActive
                                                        ? 'bg-green-900/20 border-green-500/50 shadow-[0_0_30px_rgba(168,85,247,0.15)]'
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-4 relative z-10">
                                                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center font-black text-lg shrink-0 transition-colors ${isActive ? 'bg-green-500 text-white' : 'bg-black/40 text-gray-400 group-hover:bg-white/10 group-hover:text-white'
                                                        }`}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex items-center gap-3 text-xs text-gray-500 font-medium">
                                                            <span className="capitalize text-green-400">{org.plan} Plan</span>
                                ...
                                <div className="mt-8 pt-8 border-t border-white/5">
                                    <button
                                        ...
                                        className="w-full group flex items-center justify-center gap-3 p-4 rounded-xl border border-dashed border-white/20 hover:border-green-500/50 hover:bg-green-500/10 transition-all text-gray-400 hover:text-green-300 font-bold"
                                    >
                                        <div className="w-8 h-8 rounded-full bg-white/5 group-hover:bg-green-500/20 flex items-center justify-center transition-colors">
                                            <Plus size={16} />
                                        </div>
                                        Provide New Studio
                                    </button>
                            ...
                            >
                                <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-green-500 to-blue-500" />
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-black/40 border border-white/10 focus:border-green-500 rounded-xl px-4 py-4 text-base text-white placeholder-gray-600 focus:outline-none focus:ring-4 focus:ring-green-500/20 transition-all"
                                        />
                                    </div>
