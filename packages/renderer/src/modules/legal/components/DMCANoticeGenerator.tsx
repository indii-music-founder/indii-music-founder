...
<p style="margin-top:50px;font-size:11px;color:#888"><em>Generated by indii DMCA Notice Generator. This document is a template and does not constitute legal advice. Review with qualified legal counsel before submission.</em></p>
</body></html>`;
}
