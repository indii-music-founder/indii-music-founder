...
- **Metadata Audit:** Ensure no "Black Box" royalties are lost due to bad data (missing ISRC/Splits).
- **Budgeting:** Optimize spending. Calculate the "Manager Tax" saved (20%).
- **Tax Compliance:** Collect W-8BEN/W-9 forms.
