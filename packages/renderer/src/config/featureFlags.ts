...
export const FEATURE_FLAG_NAMES = {
    ...
    CANONICAL_MUSIC_ENTITIES: 'enable_canonical_music_entities',
    DDEX_ECM: 'enable_ddex_ecm',
...
const DEFAULTS: Record<string, boolean> = {
    ...
    [FEATURE_FLAG_NAMES.CANONICAL_MUSIC_ENTITIES]: false,
    [FEATURE_FLAG_NAMES.DDEX_ECM]: false,
