...
describe('IngestionMapper', () => {
    ...
    it('should map valid profile to metadata', () => {
        const result = IngestionMapper.mapAudioProfileToMetadata(mockProfile);
    ...
    it('should handle instrumental tracks correctly', () => {
        ...
        const result = IngestionMapper.mapAudioProfileToMetadata(instrumentalProfile);
    ...
    it('should format duration correctly', () => {
        ...
        const result = IngestionMapper.mapAudioProfileToMetadata(profile);
