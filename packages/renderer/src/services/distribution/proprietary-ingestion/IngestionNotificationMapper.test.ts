...
const getDeals = (metadata: ExtendedGoldenMetadata): Deal[] => {
    const ern = IngestionNotificationMapper.mapMetadataToIngestionNotification(metadata, defaultOptions);
    return ern.dealList || [];
};

describe('IngestionNotificationMapper', () => {
    it('should map basic metadata to IngestionNotification message', () => {
        const ern = IngestionNotificationMapper.mapMetadataToIngestionNotification(MOCK_METADATA_BASE, defaultOptions);
    ...
    it('should map AI generation info correctly', () => {
        ...
        const ern = IngestionNotificationMapper.mapMetadataToIngestionNotification(aiMetadata, defaultOptions);
    ...
    it('should format duration correctly for Ingestion', () => {
        const metadata: ExtendedGoldenMetadata = {
            ...MOCK_METADATA_BASE,
        ...
        const ernLong = IngestionNotificationMapper.mapMetadataToIngestionNotification(metadataLong, defaultOptions);
    ...
    it('should add RightsController for self-publishing releases', () => {
        ...
        expect(release!.rightsControllers![0]!.entityName).toBe('Artist Records LLC');
