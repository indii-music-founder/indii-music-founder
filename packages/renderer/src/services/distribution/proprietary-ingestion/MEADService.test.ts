...
import { mediaAssetDataService } from './MediaAssetDataService';
import { MOCK_METADATA } from './IngestionNotificationService.test'; // Reuse mock metadata
import { ExtendedGoldenMetadata } from '@/services/metadata/types';

describe('MediaAssetDataService', () => {
    it('should generate a valid MediaAssetData object from metadata', () => {
        ...
        const mead = mediaAssetDataService.generateMediaAssetData(richMetadata, undefined, 'TestRecipient');

        expect(mead.messageHeader).toBeDefined();
        expect(mead.messageHeader.messageRecipient.systemIdentifier).toBe('TestRecipient');
