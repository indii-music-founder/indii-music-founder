...
class PrintOnDemandServiceClass {
    ...
    constructor() {
        ...
        // (ISSUE-1407: orders stay drafts until the paid-checkout webhook confirms).
        // NOTE (ISSUE-1417): no Prodigi provider is registered — the former
        // ProdigiProvider called pod_prodigi* callables that have no backend.
        // getProvider('prodigi') now fails loudly instead of failing at runtime.
