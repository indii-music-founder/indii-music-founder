...
`;
            ...
            return await AutonomousIntelligence.generateStructuredData<StyleComparisonResult>(
                [{ text: prompt }],
...
`;
            ...
            const dnaFields = await AutonomousIntelligence.generateStructuredData<Omit<StyleDNA, 'artistId' | 'trackCount' | 'lastUpdated'>>(
                [{ text: prompt }],
