            ...
            },
            {
                ...
                parameters: {
                    ...
                    properties: {
                        ...
                        imageUrl: { type: 'STRING', description: 'HTTPS URL or data URI for the source image when invoked from the visual annotator' },
                        maskData: { type: 'STRING', description: 'Optional PNG data URI mask generated by the visual annotator' },
                        annotations: {
                            type: 'ARRAY',
                            items: {
                                type: 'OBJECT',
