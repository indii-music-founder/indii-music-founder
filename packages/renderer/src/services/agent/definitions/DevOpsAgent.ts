...
export const DevOpsAgent: AgentConfig = {
    ...
    functions: {
        list_clusters: async () => {
            ...
            return { success: true, data: await AutonomousGenAI.generateStructuredData(prompt, { type: 'object' } as Schema) };
        },
        ...
        scale_deployment: async (args: { deployment: string, replicas: number }) => {
            ...
            return { success: true, data: { message: await AutonomousGenAI.generateText(prompt) } };
        },
        ...
        restart_service: async (args: { service_name: string }) => {
            ...
            return { success: true, data: { logs: await AutonomousGenAI.generateText(prompt) } };
        }
    },
