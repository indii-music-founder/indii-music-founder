...
export const LegalComplianceCard: AgentCard = {
    ...
    capabilities: [
        ...
        {
            name: 'assess_digital_replica_risk',
            description: 'Assess creator protection readiness for AI voice, likeness, fake endorsement, and digital replica misuse.',
            inputSchemaRef: '#/components/schemas/Empty',
            outputSchemaRef: '#/components/schemas/Empty',
            streaming: false,
        },
        {
            name: 'prepare_digital_replica_takedown',
            description: 'Draft, but do not send, a platform or legal takedown packet for suspected AI identity misuse.',
            inputSchemaRef: '#/components/schemas/Empty',
            outputSchemaRef: '#/components/schemas/Empty',
            streaming: false,
        },
        {
            name: 'review_ai_voice_likeness_clause',
            description: 'Flag AI voice, likeness, digital replica, synthetic performance, and model-training contract clauses.',
            inputSchemaRef: '#/components/schemas/Empty',
            outputSchemaRef: '#/components/schemas/Empty',
            streaming: false,
        },
