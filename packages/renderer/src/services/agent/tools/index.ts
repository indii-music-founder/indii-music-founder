...
import { LicensingTools } from './LicensingTools';
...
122. get_resized_image_variants(sourceUrl: string, dimensions: string[]) - Retrieve URLs for deterministic resizes (e.g. 1080x1080) automatically generated by Firebase storage-resize-images extension.
--- FEEDBACK ---
