...
describe('CampaignIntelligenceService', () => {
    ...
    describe('singleton export', () => {
        it('should export a singleton instance', () => {
            expect(CampaignIntelligence).toBeInstanceOf(CampaignIntelligenceService);
        });
    });
    ...
    describe('generateCampaign', () => {
        ...
        it('should generate a campaign plan from a brief', async () => {
            ...
            const result = await CampaignIntelligence.generateCampaign(brief);
        ...
        it('should inject brand context into the prompt', async () => {
            ...
            await CampaignIntelligence.generateCampaign(brief);
        ...
        it('should throw user-friendly error on failure', async () => {
            ...
            await expect(CampaignIntelligence.generateCampaign(brief)).rejects.toThrow('Failed to generate campaign');
        });
    });
    ...
    describe('planToCampaignAsset', () => {
        it('should convert a plan to CampaignAsset format', () => {
            ...
            const result = CampaignIntelligence.planToCampaignAsset(plan, '2024-01-15');
    ...
    describe('enhancePostCopy', () => {
        ...
        it('should enhance post copy with improve mode', async () => {
            ...
            const result = await CampaignIntelligence.enhancePostCopy(post, 'improve');
        ...
        it('should include platform context in enhancement prompt', async () => {
            ...
            await CampaignIntelligence.enhancePostCopy(post, 'shorter');
        ...
        it('should handle all enhancement types', async () => {
            ...
            for (const type of types) {
                await CampaignIntelligence.enhancePostCopy(post, type);
            }
    ...
    describe('generatePostImages', () => {
        it('should generate images for posts without images', async () => {
            ...
            const result = await CampaignIntelligence.generatePostImages(posts);
        ...
        it('should skip posts that already have images', async () => {
            ...
            await CampaignIntelligence.generatePostImages(posts);
        ...
        it('should call progress callback during batch processing', async () => {
            ...
            await CampaignIntelligence.generatePostImages(posts, (progress) => {
    ...
    describe('predictEngagement', () => {
        ...
        it('should predict engagement for a campaign', async () => {
            ...
            const result = await CampaignIntelligence.predictEngagement(campaign);
        ...
        it('should include campaign details in prompt', async () => {
            ...
            await CampaignIntelligence.predictEngagement(campaign);
