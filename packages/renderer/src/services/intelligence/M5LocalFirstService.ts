/**
 * M5 Local-First Autonomous Toggle Service
 *
 * Manages the user's preference for running Autonomous inference locally
 ...
 * all Intelligence service layers.
 *
...
/** Autonomous capability categories and their local-first compatibility */
...
export class M5LocalFirstService {
    /**
     * Get the user's M5 Autonomous preferences.
    ...
    /**
     * Update M5 Autonomous preferences.
     */
    ...
    /**
     * Determine routing for a specific Autonomous task.
