...
/**
 * Autonomous System Configuration Schema
...
export const RemoteIntelligenceConfigSchema = z.object({
...
export type RemoteIntelligenceConfig = z.infer<typeof RemoteIntelligenceConfigSchema>;
export type ModelPricing = z.infer<typeof ModelPricingSchema>;

/**
 * Default safe configuration if Remote Config fails
 */
export const DEFAULT_REMOTE_CONFIG: RemoteIntelligenceConfig = {
    overrides: {},
    pricing: {},
    config: {
