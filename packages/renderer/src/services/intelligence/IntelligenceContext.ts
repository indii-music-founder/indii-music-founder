/**
 * IntelligenceContext — The shared infrastructure contract for all generator modules.
 *
 * This interface bundles the ~10 dependencies that every generator needs access to.
 * `FirebaseIntelligenceService` implements this interface, exposing its private infrastructure
 * to generator modules without making them public to consumers.
 *
 * Generators receive this as their first argument: `(ctx: IntelligenceContext, ...args)`.
