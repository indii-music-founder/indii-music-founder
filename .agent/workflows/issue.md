...
name: /issue
description: >
  The Fix Agent. Scans .agent/test_ledger/OPEN_ISSUES_V3.md for unresolved issues, triages by severity,
...
> **Purpose:** Read `.agent/test_ledger/OPEN_ISSUES_V3.md`, pick up unresolved issues, and fix them.
> **Mode:** ENGINEERING — full source code access, full terminal access.
> **Counterpart:** `/mega` and `/real` find issues. `/issue` fixes them.
> **Output:** Code patches + updated issue statuses in `.agent/test_ledger/OPEN_ISSUES_V3.md`.
...
5. **You update .agent/test_ledger/OPEN_ISSUES_V3.md** after every fix with status, commit hash, and
...
/issue sync                  → Fetch open issues from GitHub, append to .agent/test_ledger/OPEN_ISSUES_V3.md, and begin fixing
```
...
2. Read the current contents of `.agent/test_ledger/OPEN_ISSUES_V3.md`.
3. For each GitHub issue returned, check if its HTML URL or Issue Number already exists in the file (idempotency check).
4. For each NEW issue, append it to the bottom of `.agent/test_ledger/OPEN_ISSUES_V3.md` in this format:
   ```markdown
...
### Step 2 — Read the full .agent/test_ledger/OPEN_ISSUES_V3.md

```bash
cat .agent/test_ledger/OPEN_ISSUES_V3.md
```
...
### 3.5 Update .agent/test_ledger/OPEN_ISSUES_V3.md
...
Input file:
  .agent/test_ledger/OPEN_ISSUES_V3.md          ← Read issues from HERE

Output:
  Code patches in the relevant source files
  Updated statuses in .agent/test_ledger/OPEN_ISSUES_V3.md
...
| Deleting issue entries from .agent/test_ledger/OPEN_ISSUES_V3.md | Never delete. Only update status. The history is sacred. |
