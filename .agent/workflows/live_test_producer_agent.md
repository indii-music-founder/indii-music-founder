---
description: How to stress test the Producer Agent in the browser
---

# Live Test: Producer Agent

**Protocol for testing Producer Agent workflows and capabilities.**

## 1. Pre-Flight

* Confirm Dev Server (`localhost:4242`).
* Nav to **Agent Workspace** or **Producer Agent** (Sidebar).
* Ensure agent context is loaded.

## 2. Trigger

* Request a budget breakdown or production schedule for a new single.
* Send the message and wait for execution.

## 3. Verify

* **Visual:** Toast ("Task completed!") + agent returns structured output in chat/canvas.
* **Functional:** Returns structured production plan and budget timeline.
