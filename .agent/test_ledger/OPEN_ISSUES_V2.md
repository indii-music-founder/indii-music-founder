...
- **Remaining:**
  ...
  4. No systematic re-grep for other `hidden md:flex` viewport-breakpoint rails beyond the one found in Publicist — the original ISSUE-1267 pattern search should be re-run with `md:` included to rule out further instances.
