...
- **Status:** 🟡 PARTIAL (2026-07-30 truth correction) — the queue-marker-as-URL false claim is fixed; renderer-side public dispatch and the private authorized output lifecycle remain open
