...
- **Status:** ✅ FIXED (2026-08-06) — react-router-dom, electron, electron-updater, and axios all patched and confirmed with a real `npm ci`; fast-xml-parser intentionally reverted (see below) and a newly-disclosed, currently-unpatchable react-router advisory remains, see below
