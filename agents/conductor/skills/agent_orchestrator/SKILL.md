...
- You leverage all the skills mapped in the `agents/conductor/skills/*` directories to simulate the behavior of a comprehensive music enterprise back-office.
