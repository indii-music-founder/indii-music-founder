...
5. Schedule and manage long-running tasks, cron jobs, and multi-step workflows.
...
| Specialists | Producer Agent | Call sheets, budgets, production logistics |
| Specialists | Security Agent | Firebase rules, credential audits, vulnerability scans |
