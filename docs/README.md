...
| [TYPESAFE_JEV_SYSTEM_ONE_GUIDE.md](./architecture/TYPESAFE_JEV_SYSTEM_ONE_GUIDE.md) | TypeSafe Jev System One registry, triggers, and Judgment 72 implementation guide |
