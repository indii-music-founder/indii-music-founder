...
gcloud firestore export gs://indii-music-founder-backups/$(date +%Y%m%d_%H%M%S)

# Export specific collection
gcloud firestore export gs://indii-music-founder-backups/users_backup \
...
```bash
gcloud firestore operations list --filter="metadata.outputUriPrefix:gs://indii-music-founder-backups"
```
