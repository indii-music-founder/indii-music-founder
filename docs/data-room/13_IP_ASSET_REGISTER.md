...
| IP-PLATFORM-003 | Immutable delivery-asset provenance: owner-scoped content-addressed audio and cover-art objects, byte/hash/format inspection, private desktop staging, and DDEX package-resource binding | Platform software. Evidence: `MasterAudioService`, `CanonicalCoverArtService`, Electron staging services, `ingestion_build.py`, and their focused renderer/main/Python/Storage-emulator tests. Customer masters and cover art remain customer-controlled unless a written transfer says otherwise. | Reduces release-integrity and manual-reconciliation risk; supports a defensible workflow/replacement-cost narrative, not an asserted patent or independent valuation. **Verified technically / needs chain-of-title and trade-secret review.** |
