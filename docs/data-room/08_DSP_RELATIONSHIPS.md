...
**Date:** 2026-04-26  
**Status:** Diligence workstream; direct production delivery not yet proven  
...
indii has distribution-readiness infrastructure for major music streaming platforms and aggregator/migration routes. Direct-to-DSP production delivery is not yet proven and should not be represented as live until testers verify credentials, delivery, acknowledgements, and reporting.

- **Lower fees:** Potential upside if direct routes are verified
- **Faster payouts:** Potential upside if direct settlement terms are verified
- **Richer metadata:** Readiness infrastructure can prepare cleaner delivery/reporting data
- **Artist control:** Migration workflows can reduce lock-in when paired with verified distribution routes

---

## Integration Matrix (Routes & Readiness)
...
**Status:** Migration route; credential verification required  
**Party ID Register:** No (CDBaby is an aggregator, not a DSP)  
**Protocol:** REST API (CDBaby Partner API)  
**Artist Count:** TBD after credential and catalog verification  
...
- Use case: Aggregator/migration path for artists who already use CD Baby or prefer aggregator operations
...
| DSP / Route | Protocol | Current Claim Status | Artist Count | Q4 2025 Streams | Q4 2025 Revenue | Payout Rate | Settlement |
|-----|----------|-----------|---------|------|-----|-----|-----|
| **Spotify** | SFTP + API | Unverified target route | TBD | TBD | TBD | TBD | TBD |
| **Apple Music** | SFTP | Unverified target route | TBD | TBD | TBD | TBD | TBD |
| **Amazon Music** | SFTP + API | Unverified target route | TBD | TBD | TBD | TBD | TBD |
| **TIDAL** | SFTP + API | Unverified target route | TBD | TBD | TBD | TBD | TBD |
| **Deezer** | SFTP | Unverified target route | TBD | TBD | TBD | TBD | TBD |
| **CDBaby** | REST API | Aggregator/migration route | TBD | TBD | TBD | TBD | TBD |
| **DistroKid** | REST API | Aggregator/migration route | TBD | TBD | TBD | TBD | TBD |
| **Symphonic** | REST API + SFTP | Aggregator/migration route | TBD | TBD | TBD | TBD | TBD |
| **TOTAL** | | | TBD | TBD | TBD | | |
...
3. **Test Release:**
   ...
   - Submits only to configured and approved DSP, distributor, or test endpoints
...
4. **Commercial Release:**
   ...
   - Submits only to configured and approved endpoints
...
5. **Defensibility:** Verified direct DSP relationships would take 6–12 months + significant legal work to rebuild; until verification, defensibility rests on workflow depth, metadata readiness, and integration scaffolding.

### Comparison to Incumbent Platforms

| Capability | indii | DistroKid | CDBaby | Amuse |
|-----------|--------|-----------|--------|-------|
| Verified Direct Spotify | Unproven | ✅ | ❌ (via aggregator) | ✅ |
| Verified Direct Apple | Unproven | ✅ | ❌ | ✅ |
| Verified Direct Amazon | Unproven | ✅ | ❌ | ✅ |
...
- [ ] Verify all target DSP/distributor endpoints and credentials
- [ ] Check SFTP/API connectivity for each approved route
...
**Status:** Diligence correction required before buyer use  
**Last Verified:** Pending tester verification  
