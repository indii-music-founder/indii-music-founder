...
const firebaseConfig = {
    ...
    authDomain: process.env.VITE_FIREBASE_AUTH_DOMAIN || "YOUR_FIREBASE_PROJECT_ID.web.app",
    databaseURL: process.env.VITE_FIREBASE_DATABASE_URL || "https://YOUR_FIREBASE_PROJECT_ID-default-rtdb.firebaseio.com",
    projectId: process.env.VITE_FIREBASE_PROJECT_ID || "YOUR_FIREBASE_PROJECT_ID",
    storageBucket: process.env.VITE_FIREBASE_STORAGE_BUCKET || "YOUR_FIREBASE_ELECTRON_APP_ID",
